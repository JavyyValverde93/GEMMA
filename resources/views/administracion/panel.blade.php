        ...
        <div class="d-flex ml-4" id="wrapper">
            ...
            <div class="bg-danger border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    {{-- <a href="{{route('lista-alumnos')}}" class="list-group-item list-group-item-action bg-danger" style="color: white;" href="#!">
                        Alumnos
                    </a> --}}
                ...
                <div class="container-fluid">
                    ...
                    <div class="row align-items-start">
                        <div class="card mt-2 ml-5 mr-2 w-20 text-danger">
                            <div class="card-body">                            
                              <h5 class="card-title">Profesores<span class="material-icons align-middle" style="font-size: 40px;">school</span></h5>
                            </div>
                        </div>
                        <div class="card mt-2 ml-4 mr-2 w-20 text-danger">
                            <div class="card-body">                            
                              <h5 class="card-title">Coordinadores<span class="material-icons align-middle" style="font-size: 40px;">supervisor_account</span></h5>
                            </div>
                        </div>
                        <div class="card mt-2 ml-4 mr-2 w-20 text-danger">
                            <div class="card-body">                            
                              <h5 class="card-title">Administradores<span class="material-icons align-middle" style="font-size: 40px;">admin_panel_settings</span></h5>
                            </div>
                        </div>
                        <div class="card mt-2 ml-4 mr-2 w-20 text-danger">
                            <div class="card-body">                            
                              <h5 class="card-title">Incidencias<span class="material-icons align-middle" style="font-size: 40px;">report_problem</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
